...
final class Version20230321230451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE locataire (id INT AUTO_INCREMENT NOT NULL, propreitaire_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, numero VARCHAR(255) NOT NULL, INDEX IDX_C47CF6EB8ACD1DD0 (propreitaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
