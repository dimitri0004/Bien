...
class AgentImmobilierController extends AbstractController
{
    ...
    public function create(Request $request , AgentImmobilierRepository $agentImmobilierRepository,EntityManagerInterface $entityManagerInterface): Response
    {
        ...
        return $this->renderForm('agent_immobilier/index.html.twig', [
            'form' => $form,
        ]);
    }
    ...
    public function update(Request $request , AgentImmobilierRepository $agentImmobilierRepository,EntityManagerInterface $entityManagerInterface): Response
    {
